...
function faitMeuble(params, dM){
  ...
  for(i in dM.nDefs){
      ...
      else        meuble = union(meuble, niche)
  }

  if(dM.symX) meuble = union(meuble, mirrorX(meuble))
  if(dM.symY) meuble = union(meuble, mirrorY(meuble))
...
function RecupDonneesModele(mNum){
  ...
  switch(mNum){
    case 1: // 3 niches
        console.log("M1")
        p= [[0,0],[20,0],[28,16],[16,24],[24,40],[0,40],[8,24],[0,16]]
        n = [[0,1,2,7], [7,2,3,6], [6,3,4,5]]
        X = false
        Y = false
        break
      
    case 2: // Quart (sym. en X et Y)
        p = [[12,0],[40,0],[32,32],[0,40],[0,20],[16,16]]
        n = [[0,1,2,5],[2,3,4,5]]
        X = true
        Y = true
        break
    ...
    case 3: // Etoile (sym. en X et Y)
        p = [[0,0],[16,0],[32,0],[28,16],[32,32],[16,32],[0,32],[0,16],[10,22],[22,22],[22,10],[10,10]]
        n = [[0,1,10,11,7],[1,2,3,9,10],[5,6,7,11,8]]
        X = true
        Y = true
        break
      
    case 4: // Opus Incertum
        p = [[-41,-43],[-35,-43],[-10,-43],[28,-43],[43,-43],[43,-36],[43,-3],[43,26],[43,37],[43,41],[11,41],[-13,41],[-41,41],[-38,30],[-41,-12],[-30,-23],[-15,-21],[-7,-36],[24,-34],[29,-40],[30,-14],[30,10],[15,9],[9,-4],[-8,-8],[-26,18],[-17,16],[7,22],[15,36]]
        n = [[0,1,15,14],[1,2,17,16,15],[2,3,19,18,17],[3,4,5,6,20,18,19],[16,17,18,20,23,24],[14,15,16,24,26,25],[12,14,25,13],[20,6,21,22,23],[6,7,21],[24,23,22,27,26],[22,21,7,8,28,27],[8,9,10,28],[10,11,26,27,28],[11,12,13,25,26]]
        X = false
        Y = false
        break;
        
    case 5: // Base Hexa (sym. en X et Y)
        p = [[0,0],[25,0],[51,0],[48,18],[38,33],[23,45],[0,51],[0,16],[29,16]]
        n = [[1,2,3,4,8],[4,5,6,7,8]]
        X = true
        Y = true
        break
      
    case 6: // Cosima
        p = [[-48,-50],[-13,-51],[22,-52],[50,-52],[50,-23],[51,12],[53,49],[15,49],[-20,49],[-50,49],[-49,19],[-48,-14],[-21,-22],[14,-14],[21,20],[-12,11]]
        n = [[0,1,12,11],[1,2,13,12],[2,3,4,13],[10,11,12,15],[4,5,14,13],[5,6,7,14],[7,8,15,14],[8,9,10,15]]
        X = false
        Y = false
        break
      
    case 7: // Escalier 4321
        p = [[-32,-32],[-16,-32],[0,-32],[16,-32],[32,-32],[32,-16],[16,-16],[16,0],[0,0],[0,16],[-16,16],[-16,32],[-32,32],[-32,16],[-32,0],[-32,-16],[-16,0],[-16,-16],[0,-16]]
        n = [[3,4,5,6],[2,3,6,18],[1,2,18,17],[0,1,17,15],[6,7,8,18],[8,16,17,18],[14,15,17,16],[8,9,10,16],[10,13,14,16],[10,11,12,13]]
        X = false
        Y = false
        break
      
    case 8: // Silhouette
        p = [[-28,-44],[28,-44],[24,-23],[20,-11],[24,3],[34,20],[-34,20],[-24,3],[-20,-11],[-24,-23]]
        n = [[0,1,2,3,8,9],[3,4,5,6,7,8]]
        X = false
        Y = false
        break
      
    case 9: // Penta
        p = [[-33,-48],[-11,-49],[28,-52],[35,-27],[48,15],[28,27],[-8,48],[-24,33],[-51,7],[-45,-11],[-28,2],[-19,-24],[7,-26],[17,1],[-6,18]]
        n = [[0,1,11,10,9],[1,2,3,12,11],[3,4,5,13,12],[5,6,7,14,13],[7,8,9,10,14]]
        X = false
        Y = false
        break
}
return {pts:p, nDefs:n, symX:X, symY:Y}
}

function getParameterDefinitions () {
    return [
        { name: 'modele', type: 'choice', caption:'Modele', initial:1,
        ...
        { name: 'sym', type:'choice', caption:'Symetrie', initial: "", 
            values:['','X','Y','XY'],
