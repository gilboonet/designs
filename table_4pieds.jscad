...
function getParameterDefinitions () {
  return [
    ...
    {name: 'P_Largeur', type: 'float', caption:'Largeur', initial:45 },
    ...
    {name: 'modele', type: 'text', caption:'modele', initial:"polygon([[16,32],[22,24],[25,0],[22,-20],[11,-27],[4,-21],[6,-21],[11,-25],[19,-19],[18,-4],[16,5],[10,8],[0,8],[0,32]]);polygon([[14,24],[16,24],[16,22],[14,21]]);polygon([[19,9],[22,12],[24,-1],[21,-13],[22,-3],[22,2],[20,0],[20,3],[22,4],[22,8],[21,9],[20,8]]);polygon([[2,26],[3,28],[6,29],[10,27],[8,19],[4,16],[5,19],[7,22],[7,25],[6,27],[4,25],[5,23],[3,20]]);"}
  ];
}

function recupPolys(ch){
    var re, res, P;
    
    re = /\[\[[^)]*\]\]/g;
    P = [];
    while ((res = re.exec(ch)) !== null) {
        res[0]= res[0].replace(/\/\*[^*]*\*\//g,'');
        P.push(polygon(JSON.parse(res[0])));
    }
    return P;
}

function main(params){
    pTrous = recupPolys(params.modele);
    pFond = pTrous.shift();
    ...
    plateau = plateau.translate([0,b[1].y + params.P_Prof/2,0]);
