...
function getParameterDefinitions() {
  return [
    ...
    { name: 'epaisseur', type: 'float', initial: 0.6, caption: "Epaisseur:" },
    { name: 'hauteur', type:'float', initial: 4, caption: "Hauteur:"},
    { name: 'encoches', type:'text', initial: "3;7,2.5", caption: "Encoches:"},
